...
class ARDemandeCorrectionDocumentation(models.Model):
    _name = "ar.demande.correction.documentation"
    _description = "Correction écarts - Documentation"
    _order = "create_date desc"
    _inherit = ["mail.thread", "mail.activity.mixin"]

    description = fields.Char(string="Description", required=True, tracking=True)

    file_data = fields.Binary(string="Fichier", required=False, attachment=True)
